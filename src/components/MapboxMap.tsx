    ...
    return (
      ...
      >
        ...
        <p className="font-serif text-sm text-ink-soft max-w-md mx-auto leading-relaxed">
          Set <code className="font-mono text-xs bg-parchment-100 px-1 py-0.5 rounded">VITE_MAPBOX_TOKEN</code>{" "}
          via the <code className="font-mono text-xs bg-parchment-100 px-1 py-0.5 rounded">cf-worker-secret-bulk</code>{" "}
          workflow (or in a local <code className="font-mono text-xs bg-parchment-100 px-1 py-0.5 rounded">.env</code> file)
          to render the Mapbox map. Free public tokens at{" "}
          <a
