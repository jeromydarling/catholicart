...
export function seedCommissions(): Commission[] {
  ...
  const c1: Commission = {
    ...
    messages: [
      msg("system", "Locavit", "Mary Beauchamp sent a request.", 30),
      ...
      msg("system", "Locavit", "Artist quoted $2,400. Three milestones funded as work progresses.", 28),
      msg("system", "Locavit", "Mary Beauchamp funded the deposit milestone. Funds held in escrow.", 22),
      msg("artist", "Annunciata Park",
        "The poplar panel is gessoed and rubbed smooth. Beginning the underdrawing tomorrow.", 18),
      msg("system", "Locavit", "Mary Beauchamp released the deposit milestone to the artist.", 21),
      msg("artist", "Annunciata Park",
  ...
  const c2: Commission = {
    ...
    messages: [
      msg("system", "Locavit", "Fr. James Aldworth sent a request.", 4),
      ...
      msg("system", "Locavit", "Artist quoted $950. Three milestones funded as work progresses.", 2),
    ],
    wip: [],
  ...
  const c3: Commission = {
    ...
    messages: [
      msg("system", "Locavit", "St. Bartholomew sent a request.", 130),
      ...
      msg("system", "Locavit", "Artist quoted $1,800. Three milestones funded as work progresses.", 128),
      msg("system", "Locavit", "Rector funded the deposit. Funds held in escrow.", 121),
      msg("system", "Locavit", "Rector released the deposit milestone to the artist.", 120),
      ...
      msg("system", "Locavit", "Rector released the midpoint milestone to the artist.", 60),
      msg("artist", "Felix Donnegan", "Final pass on the wounds and feet. Linseed oil rub.", 35),
      msg("system", "Locavit", "Rector released the final payment. Commission delivered.", 30),
    ],
    wip: [
